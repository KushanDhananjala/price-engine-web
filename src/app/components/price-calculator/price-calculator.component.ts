...
import {ProductPriceModalComponent} from "../product-price-modal/product-price-modal.component";
...
export class PriceCalculatorComponent implements OnInit {
  ...
  openPriceDialog(price: number, product: string, cartons: number, units: number) {
    this.dialog.open(ProductPriceModalComponent, {
      data: new PriceModal(price, product, cartons, units)
    });
  }

  validateQuantity(cartonQuantity: string, unitQuantity: string) {
